<!-- https://github.com/unovue/inspira-ui/blob/2540e89663b09d983319577f75400f1ccf1f9f4c/components/content/inspira/ui/fluid-cursor/FluidCursor.vue -->
  ...
  const advectionShader = compileShader(
    ...
    `
        ...
        void main () {
            ...
            vec2 coord = uv - dt * bilerp(uVelocity, vUv, texelSize).xy * texelSize;
