<template>
  <a
    ...
    target="_blank"
    class="text-xl text-gray-600 transition-colors right-4 top-4 absolute z-99 hover:text-gray-900 hover:scale-110"
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 16 16"><path
      fill="currentColor"
